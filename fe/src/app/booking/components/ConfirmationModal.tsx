...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({ isOpen, onClose, details }) => {
    ...
    const bookingItemPrice = details.mode === 'court' ? details.courtPrice : details.sessionPrice;
        ...
        <div className={styles.modalOverlay}>
            <div className={styles.modalContent}>
                ...
                <div className={styles.modalSection}>
                    ...
                    {details.mode === 'court' && details.date && details.startTime && details.endTime && details.duration && details.courtNumber && details.courtType && (
                        <>
                            <p><strong>Type:</strong> Court Booking</p>
                    ...
                    {details.mode === 'training' && details.sessionName && details.sessionCoach && details.sessionSchedule && (
                         <>
                            <p><strong>Type:</strong> Training Session</p>
                            <p><strong>Session:</strong> {details.sessionName}</p>
                            <p><strong>Coach:</strong> {details.sessionCoach}</p>
                            <p><strong>Schedule:</strong> {details.sessionSchedule}</p>
                         </>
                    )}
                </div>
                ...
                <div className={styles.modalSection}>
                    ...
                    <div className={styles.modalSummaryItem}>
                        <span>
                            {details.mode === 'court' ? 'Court Booking:' : 'Training Session:'}
                        </span>
