	...
	const courts: Court[] = [
		{
			id: 1,
			name: "Court 1",
			features: ["Premium flooring", "Tournament standard"],
			isPremium: true,
		},
		{
			id: 2,
			name: "Court 2",
			features: ["Good for beginners", "Natural lighting"],
		},
		{
			id: 3,
			name: "Court 3",
			features: ["Professional setup", "Video recording available"],
		},
		{
			id: 4,
			name: "Court 4",
			features: ["Recently renovated", "Air-conditioned"],
			isPremium: true,
		},
		{
			id: 5,
			name: "Court 5",
			features: ["Corner location", "Extra space around court"],
		},
		{
			id: 6,
			name: "Court 6",
			features: ["Specialized lighting", "Premium shuttlecocks included"],
		},
	];
			...
			<div className={styles.courtsGrid}>
				{courts.map((court) => (
					<div
						...
						} ${court.isPremium ? styles.premium : ""}`} // <-- ADDED premium class
