		...
		<section className={styles.infoSection}>
			...
			<div className={styles.infoGrid}>
				...
				<div className={styles.infoCard}>
					...
					<p>
						Peak Hours (5 PM - 9 PM, Weekdays):{" "}
						{peakRate.toLocaleString("vi-VN")} VND
					</p>
					<p>
						Off-Peak Hours (Weekdays):{" "}
						{offPeakRate.toLocaleString("vi-VN")} VND
					</p>
					<p>
						Weekend Rate: {weekendRate.toLocaleString("vi-VN")} VND
					</p>
					<p>
						<strong>Premium Courts (1 & 4):</strong> +
						{premiumSurcharge.toLocaleString("vi-VN")} VND surcharge
					</p>
				</div>
				{/* --- MODIFICATION END --- */}
